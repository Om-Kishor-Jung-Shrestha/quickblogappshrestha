...
import {assets, dashboard_data as dashbooardData, dashboard_data} from "../../assets/assets.js";
    ...
    return (
        <div className='flex-1 p-4 md:p-10 bg-blue-50/50'>
            ...
            <div>
                ...
                <div className='relative max-w-4xl overflow-x-auto shadow rounded-lg scrllbar-hide bg-white'>
